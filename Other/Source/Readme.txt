...
user in an INI file next to ConsoleForCygwinPortable.exe called
ConsoleForCgywinPortable.ini.
...
copy AppNamePortable.ini from this directory to ConsoleForCygwinPortable.ini
next to ConsoleForCgywinPortable.exe.  The options in the INI file are as
follows:
